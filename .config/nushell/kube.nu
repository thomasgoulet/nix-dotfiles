module kube {
    ...
    export def kd [
        ...
        ...resources: string@"nu-complete kubectl kind instances" # Resources to delete
        ...
        $resources
        | each {|r| 
            kubectl delete ...$extra_arg $kind $r
        };
        return;
    }
    ...
    export def ke [
        ...
        if ($resource == null) {
            kubectl edit $kind ...$extra_arg
            return;
        }
        kubectl edit $kind $resource
